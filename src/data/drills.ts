...
export const FOOTBALL_DRILLS: DrillExercise[] = [
  ...
  { id:'fb-o01', sport:'football', category:'offensivt', name:'Rondó 4v2', duration:15, players:'6', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Sett opp sirkel Ø8m' }, { id:'s2', name:'Steg 2', description:'4 angripere rundt, 2 forsvarere inni' }, { id:'s3', name:'Steg 3', description:'Maks 2 touch per spiller' }, { id:'s4', name:'Steg 4', description:'Taper ballen bytter med forsvareren som vant den' }, { id:'s5', name:'Steg 5', description:'Mål: 20 pass uten å miste' }],
  ...
  { id:'fb-o02', sport:'football', category:'offensivt', name:'Pasningsfirkant 1–2-touch', duration:15, players:'4–8', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'4 kjegler i 10×10m firkant' }, { id:'s2', name:'Steg 2', description:'En spiller per hjørne' }, { id:'s3', name:'Steg 3', description:'Pass til høyre med ett touch' }, { id:'s4', name:'Steg 4', description:'Etter pasning: løp til ballen du sendte' }, { id:'s5', name:'Steg 5', description:'Bytt retning etter 3 min' }],
  ...
  { id:'fb-o03', sport:'football', category:'offensivt', name:'1v1 gjennombrudd', duration:20, players:'2–12', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Kanal 12m bred × 18m lang' }, { id:'s2', name:'Steg 2', description:'Angriper starter med ball' }, { id:'s3', name:'Steg 3', description:'Forsvareren 3m foran angriperen' }, { id:'s4', name:'Steg 4', description:'Angriperen: nå baklinjen' }, { id:'s5', name:'Steg 5', description:'Bytt roller etter hvert gjennombrudd' }],
  ...
  { id:'fb-o04', sport:'football', category:'offensivt', name:'Veggpasning (giv-og-gå)', duration:20, players:'3–9', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'A passer til B (vegg)' }, { id:'s2', name:'Steg 2', description:'B ett-touch tilbake til A i løp' }, { id:'s3', name:'Steg 3', description:'A leverer til C som bryter fri' }, { id:'s4', name:'Steg 4', description:'Roter roller etter 5 kombinasjoner' }],
  ...
  { id:'fb-o05', sport:'football', category:'offensivt', name:'Kontring 3v2', duration:20, players:'5+', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'3 angripere mot 2 forsvarere fra midtbanen' }, { id:'s2', name:'Steg 2', description:'Angrepet starter på signal' }, { id:'s3', name:'Steg 3', description:'Avslutt innen 10 sekunder' }, { id:'s4', name:'Steg 4', description:'Forsvarerne samler seg sentralt' }, { id:'s5', name:'Steg 5', description:'Bytt roller etter hvert angrep' }],
  ...
  { id:'fb-o06', sport:'football', category:'offensivt', name:'Overlappskombinasjon med kant', duration:20, players:'4–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Kant mottar fra midtbane' }, { id:'s2', name:'Steg 2', description:'Back løper overlapp utenfra' }, { id:'s3', name:'Steg 3', description:'Kant holder ballen til back er forbi' }, { id:'s4', name:'Steg 4', description:'Back mottar og slår innlegg' }],
  ...
  { id:'fb-o07', sport:'football', category:'offensivt', name:'Avslutning fra innlegg', duration:20, players:'5–10', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Innlegger ved flanken' }, { id:'s2', name:'Steg 2', description:'2 angripere: fremstolpe og bakstolpe' }, { id:'s3', name:'Steg 3', description:'Innlegger slår inn' }, { id:'s4', name:'Steg 4', description:'Spiss ved fremstolpe angriper sin sone' }, { id:'s5', name:'Steg 5', description:'Midtbane dekker bakstolpe' }],
  ...
  { id:'fb-o08', sport:'football', category:'offensivt', name:'Fri pasningstrening (sirkulasjon)', duration:20, players:'8–11', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Fullt lag i sin formasjon på halvbane' }, { id:'s2', name:'Steg 2', description:'Spill 50%, deretter 75%, deretter 100%' }, { id:'s3', name:'Steg 3', description:'Legg inn 4 skyggepress etter 10 min' }, { id:'s4', name:'Steg 4', description:'Krav: maks 2 touch i sentrum' }],
  ...
  { id:'fb-o09', sport:'football', category:'offensivt', name:'Skuddtrening fra distanse', duration:20, players:'2–10', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Kø 20m fra mål' }, { id:'s2', name:'Steg 2', description:'Dribble 3 steg, sett opp' }, { id:'s3', name:'Steg 3', description:'Skudd med vristsparka — plasser i hjørne' }, { id:'s4', name:'Steg 4', description:'Bytt side etter 5 skudd' }, { id:'s5', name:'Steg 5', description:'Statisk ball fra ulike posisjoner' }],
  ...
  { id:'fb-o10', sport:'football', category:'offensivt', name:'Posisjonsspill 5v5+2 (joker)', duration:25, players:'12', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Halvbane; 5v5 med 2 jokere' }, { id:'s2', name:'Steg 2', description:'Jokere spiller alltid med ballholder' }, { id:'s3', name:'Steg 3', description:'Mål: angrep via minimum 2 pasninger' }, { id:'s4', name:'Steg 4', description:'Bytt jokere hvert 5. min' }],
  ...
  { id:'fb-o11', sport:'football', category:'offensivt', name:'Friløp og timing i dybden', duration:20, players:'4–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Angriper 5m foran forsvarslinja' }, { id:'s2', name:'Steg 2', description:'Signal: angriper peker og starter løpet' }, { id:'s3', name:'Steg 3', description:'Midtbane slår dybdeball på 1. steg' }, { id:'s4', name:'Steg 4', description:'Angriper: motta og avslutt' }],
  ...
  { id:'fb-o12', sport:'football', category:'offensivt', name:'Frispark-trening', duration:20, players:'3–6', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Mur 9.15m fra ballen' }, { id:'s2', name:'Steg 2', description:'Frispark direkte over/rundt mur' }, { id:'s3', name:'Steg 3', description:'Variasjon: én løper over ballen, neste skyter' }, { id:'s4', name:'Steg 4', description:'Keeper aktiv' }],
  ...
  { id:'fb-o13', sport:'football', category:'offensivt', name:'Heading mot mål', duration:15, players:'2–10', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Server kaster fra siden' }, { id:'s2', name:'Steg 2', description:'Angriper løper mot ballen' }, { id:'s3', name:'Steg 3', description:'Heading mot mål' }, { id:'s4', name:'Steg 4', description:'Fra fremstolpe, bakstolpe og bakre sone' }, { id:'s5', name:'Steg 5', description:'Keeper etter 8 min' }],
  ...
  { id:'fb-o14', sport:'football', category:'offensivt', name:'Kantspill og innlegg', duration:25, players:'5–10', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Kant mottar fra midtbane' }, { id:'s2', name:'Steg 2', description:'Dribble mot baklinjen' }, { id:'s3', name:'Steg 3', description:'Innlegg: fremstolpe / bak 5-meteren / tilbake til 16m' }, { id:'s4', name:'Steg 4', description:'2 angripere timer løp' }],
  ...
  { id:'fb-o15', sport:'football', category:'offensivt', name:'Sidevendt mottak og vending', duration:15, players:'2–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Spiller i midten; pasning fra én side' }, { id:'s2', name:'Steg 2', description:'Mottaker åpner kropp mot begge retninger' }, { id:'s3', name:'Steg 3', description:'Første touch inn til neste pasning' }, { id:'s4', name:'Steg 4', description:'Neste pasning sendes motsatt side' }],
  ...
  { id:'fb-o16', sport:'football', category:'offensivt', name:'Tredjemann-kombinasjon', duration:25, players:'6–10', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'A→B, B→C (skjerm)' }, { id:'s2', name:'Steg 2', description:'C ryggen til, legger til D som bryter' }, { id:'s3', name:'Steg 3', description:'D avslutter mot mål' }, { id:'s4', name:'Steg 4', description:'Roter etter 4 min' }],
  ...
  { id:'fb-o17', sport:'football', category:'offensivt', name:'Sprint etter ball — 1v1 konkurranse', duration:15, players:'2–12', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'To spillere ryggen til hverandre, 3m fra ball' }, { id:'s2', name:'Steg 2', description:'Trener slår ball 20m fremover på signal' }, { id:'s3', name:'Steg 3', description:'Begge løper om ballen' }, { id:'s4', name:'Steg 4', description:'Den som når ballen: avslutning mot mål' }],
  ...
  { id:'fb-o18', sport:'football', category:'offensivt', name:'Overtal-spill 6v4', duration:25, players:'10+', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'6 angrep vs 4 forsvar på halvbane' }, { id:'s2', name:'Steg 2', description:'Mål: sett opp avslutning innen 12 sek' }, { id:'s3', name:'Steg 3', description:'Forsvar: kompakt, ingen offensivt' }, { id:'s4', name:'Steg 4', description:'Bytt lag etter hvert angrep' }],
  ...
  { id:'fb-o19', sport:'football', category:'offensivt', name:'Dribling med Cruyff-vending', duration:15, players:'2–15', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Dribble mot kjegle' }, { id:'s2', name:'Steg 2', description:'Fakt innspill' }, { id:'s3', name:'Steg 3', description:'Trekk ballen bakover med innsiden' }, { id:'s4', name:'Steg 4', description:'Vend 180° og akselerér' }, { id:'s5', name:'Steg 5', description:'Øv begge retninger' }],
  ...
  { id:'fb-o20', sport:'football', category:'offensivt', name:'Dribble-kurs med avslutning', duration:20, players:'2–10', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'6 kjegler slalåm, 18m til mål' }, { id:'s2', name:'Steg 2', description:'Dribl gjennom kjeglene' }, { id:'s3', name:'Steg 3', description:'Avslutning etter siste kjegle' }, { id:'s4', name:'Steg 4', description:'Bytt side etter 3 runder' }],
  ...
  { id:'fb-d01', sport:'football', category:'defensivt', name:'Press-signal og høyt press', duration:20, players:'6–11', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Oppbygging 4-back mot 4 angripere' }, { id:'s2', name:'Steg 2', description:'Trener passer ball til bestemt spiller (= signal)' }, { id:'s3', name:'Steg 3', description:'Nearest: press direkte mot ballen' }, { id:'s4', name:'Steg 4', description:'Andre komprimerer nærmeste linje' }],
  ...
  { id:'fb-d02', sport:'football', category:'defensivt', name:'1v1 forsvar — posisjon og timing', duration:20, players:'2–12', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Angriper mot forsvareren i kanal' }, { id:'s2', name:'Steg 2', description:'Forsvareren: sett press men hold form' }, { id:'s3', name:'Steg 3', description:'Vent på feil fra angriperen' }, { id:'s4', name:'Steg 4', description:'Glidtakling: velg riktig øyeblikk' }],
  ...
  { id:'fb-d03', sport:'football', category:'defensivt', name:'Back-4 komprimering', duration:25, players:'6–8', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'4 forsvarere på linja' }, { id:'s2', name:'Steg 2', description:'Trener peker/passer ball til ulike punkter' }, { id:'s3', name:'Steg 3', description:'Back-4 glider mot ballen' }, { id:'s4', name:'Steg 4', description:'Legg til angriper etter 10 min' }],
  ...
  { id:'fb-d04', sport:'football', category:'defensivt', name:'Gegenpressing etter balltap', duration:20, players:'6–8', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'5v5 + keeper på halvbane' }, { id:'s2', name:'Steg 2', description:'TRENER piper = balltap' }, { id:'s3', name:'Steg 3', description:'5 spillere presser ALLE mot ballen' }, { id:'s4', name:'Steg 4', description:'Mål: gjenvinne innen 5 sek' }],
  ...
  { id:'fb-d05', sport:'football', category:'defensivt', name:'Offsidefellen', duration:20, players:'5–9', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'4 backer stiller opp' }, { id:'s2', name:'Steg 2', description:'Keeper/back roper "step" på signal' }, { id:'s3', name:'Steg 3', description:'Alle 4 løper fremover SIMULTANT' }, { id:'s4', name:'Steg 4', description:'Angriper fanges i offside' }],
  ...
  { id:'fb-d06', sport:'football', category:'defensivt', name:'Forsvare innlegg', duration:20, players:'4–7', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Kant på flanken' }, { id:'s2', name:'Steg 2', description:'Back setter press og kanaliserer' }, { id:'s3', name:'Steg 3', description:'Kant slår innlegg' }, { id:'s4', name:'Steg 4', description:'Back: finn angriperen (ikke ballen)' }, { id:'s5', name:'Steg 5', description:'Hode bort innlegget' }],
  ...
  { id:'fb-d07', sport:'football', category:'defensivt', name:'Sentralt forsvar 2v2', duration:20, players:'4–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Firkant 12×12m; 2v2' }, { id:'s2', name:'Steg 2', description:'Angriperne: hold ballen 60 sek' }, { id:'s3', name:'Steg 3', description:'Forsvarerne: gjenvinne' }, { id:'s4', name:'Steg 4', description:'Bytt hver 90 sek' }],
  ...
  { id:'fb-d08', sport:'football', category:'defensivt', name:'Forsvare hjørnespark', duration:15, players:'8–11', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'3 i zonal marking på 5m-boksen' }, { id:'s2', name:'Steg 2', description:'2 man-marker farlige angripere' }, { id:'s3', name:'Steg 3', description:'1 spiller nær ballen' }, { id:'s4', name:'Steg 4', description:'Keeper kommanderer' }],
  ...
  { id:'fb-d09', sport:'football', category:'defensivt', name:'Lav blokkering 5-4-1', duration:25, players:'10–11', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Lag i 5-4-1 i eget halvplan' }, { id:'s2', name:'Steg 2', description:'Motstand (6 spillere) har ball' }, { id:'s3', name:'Steg 3', description:'Laget holder kompakt blokk' }, { id:'s4', name:'Steg 4', description:'Bytt etter 5 min' }],
  ...
  { id:'fb-d10', sport:'football', category:'defensivt', name:'Dobbelpress og gjenvinning', duration:15, players:'4–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'1 angriper mot 2 forsvarere i kanal' }, { id:'s2', name:'Steg 2', description:'Første forsvarspiller presser og kanaliserer' }, { id:'s3', name:'Steg 3', description:'Andre venter og tar ballen dit den kanaliseres' }],
  ...
  { id:'fb-d11', sport:'football', category:'defensivt', name:'Midtbane-blokkering', duration:15, players:'4–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'3 midtbanespillere i trekant' }, { id:'s2', name:'Steg 2', description:'2 angripere prøver å passere' }, { id:'s3', name:'Steg 3', description:'Trekanten forflyttes som enhet' }, { id:'s4', name:'Steg 4', description:'Ingen passer gjennom' }],
  ...
  { id:'fb-d12', sport:'football', category:'defensivt', name:'Dekke løp i dybden', duration:20, players:'4–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Forsvareren og angriper side ved side' }, { id:'s2', name:'Steg 2', description:'Signal: angriper sprinter dypt' }, { id:'s3', name:'Steg 3', description:'Forsvareren: følg men hold avstand' }, { id:'s4', name:'Steg 4', description:'Pasning slås inn i dybden' }],
  ...
  { id:'fb-d13', sport:'football', category:'defensivt', name:'Pressing 4-3-3 med triggere', duration:25, players:'9–11', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Lag i 4-3-3' }, { id:'s2', name:'Steg 2', description:'Trener slår ball til bestemt posisjon' }, { id:'s3', name:'Steg 3', description:'Nærmeste angriper: press direkte' }, { id:'s4', name:'Steg 4', description:'Alle andre komprimerer langs linjene' }],
  ...
  { id:'fb-d14', sport:'football', category:'defensivt', name:'Covering og sone-forsvar', duration:25, players:'7–11', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'4-4 mot 6 angripere' }, { id:'s2', name:'Steg 2', description:'Forsvarslinjene dekker soner' }, { id:'s3', name:'Steg 3', description:'Angripere løper inn og ut' }, { id:'s4', name:'Steg 4', description:'Forsvarere: følg SONEN, ikke mannen' }],
  ...
  { id:'fb-d15', sport:'football', category:'defensivt', name:'Forsvar ved overgang', duration:20, players:'7–11', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Lag i angrepposisjon' }, { id:'s2', name:'Steg 2', description:'Signal: balltap' }, { id:'s3', name:'Steg 3', description:'Alle løper tilbake til 4-4-2' }, { id:'s4', name:'Steg 4', description:'Tidsbegrensning: 5 sek' }, { id:'s5', name:'Steg 5', description:'Legg til kontrangrep' }],
  ...
  { id:'fb-t01', sport:'football', category:'hele_laget', name:'11v11 taktikkspill', duration:40, players:'22', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Fullt lag i kamp-utstyr' }, { id:'s2', name:'Steg 2', description:'Fokus: ett taktisk tema per økt' }, { id:'s3', name:'Steg 3', description:'Trener stopper og korrigerer' }, { id:'s4', name:'Steg 4', description:'15 min angrep, 15 min forsvar' }, { id:'s5', name:'Steg 5', description:'Avslutning: fri kamp' }],
  ...
  { id:'fb-t02', sport:'football', category:'hele_laget', name:'Oppvarming med ball', duration:15, players:'alle', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'2 min lett jogg' }, { id:'s2', name:'Steg 2', description:'Pasning i par i bevegelse' }, { id:'s3', name:'Steg 3', description:'Dynamiske strekk' }, { id:'s4', name:'Steg 4', description:'Sprintstarter x4 per side' }, { id:'s5', name:'Steg 5', description:'Mini-rondó 4v2 i 3 min' }],
  ...
  { id:'fb-t03', sport:'football', category:'hele_laget', name:'Posisjonsspill halvbane 6v6', duration:25, players:'12+', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'6v6 på halvbane med keepere' }, { id:'s2', name:'Steg 2', description:'Fritt spill 5 min' }, { id:'s3', name:'Steg 3', description:'Trener stopper og korrigerer' }, { id:'s4', name:'Steg 4', description:'Gjenspill med én begrensning' }],
  ...
  { id:'fb-t04', sport:'football', category:'hele_laget', name:'Sett-stykke trening', duration:25, players:'11', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Øv 5 hjørnespark-varianter' }, { id:'s2', name:'Steg 2', description:'Øv 3 frispark-varianter' }, { id:'s3', name:'Steg 3', description:'Legg inn passive motstandere' }, { id:'s4', name:'Steg 4', description:'Aktive motstandere 50%' }],
  ...
  { id:'fb-t05', sport:'football', category:'hele_laget', name:'Overgang angrep-forsvar', duration:25, players:'10–14', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'8v8 på halvbane' }, { id:'s2', name:'Steg 2', description:'Score/tap = umiddelbar omstilling' }, { id:'s3', name:'Steg 3', description:'Forsvar: reorganiser til 4-4 på 3 sek' }, { id:'s4', name:'Steg 4', description:'Teller vellykkede overganger' }],
  ...
  { id:'fb-t06', sport:'football', category:'hele_laget', name:'Kondisjonsspill 5v5 høyt press', duration:25, players:'10', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'5v5 på 40×25m' }, { id:'s2', name:'Steg 2', description:'Laget som mister presser umiddelbart' }, { id:'s3', name:'Steg 3', description:'Maks 3 touch' }, { id:'s4', name:'Steg 4', description:'Poeng kun etter 4+ pasninger' }, { id:'s5', name:'Steg 5', description:'3×5 min med 2 min pause' }],
  ...
  { id:'fb-t07', sport:'football', category:'hele_laget', name:'Pasningsbevegelse i 3-linjer', duration:20, players:'9–11', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'4 back, 3 midtbane, 3 front' }, { id:'s2', name:'Steg 2', description:'Keeper starter' }, { id:'s3', name:'Steg 3', description:'Spill frem: back → midtbane → front' }, { id:'s4', name:'Steg 4', description:'Alle linjer berører ballen' }, { id:'s5', name:'Steg 5', description:'Press etter 5 runder' }],
  ...
  { id:'fb-t08', sport:'football', category:'hele_laget', name:'Treningskamp med taktisk fokus', duration:60, players:'14–22', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'11v11' }, { id:'s2', name:'Steg 2', description:'Fokus: ett taktisk tema' }, { id:'s3', name:'Steg 3', description:'Trener stopper maks 5 ganger' }, { id:'s4', name:'Steg 4', description:'Siste 15 min: fritt spill' }, { id:'s5', name:'Steg 5', description:'Evaluering i garderobe' }],
  ...
  { id:'fb-t09', sport:'football', category:'hele_laget', name:'Psykisk presstrening', duration:25, players:'10–14', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'8v8: 1-touch max' }, { id:'s2', name:'Steg 2', description:'Timer: 5 sek per berøring' }, { id:'s3', name:'Steg 3', description:'Trener endrer regler underveis' }, { id:'s4', name:'Steg 4', description:'Tilpasning under press er målet' }],
  ...
  { id:'fb-t10', sport:'football', category:'hele_laget', name:'Formasjonell angrepstrening 11v0', duration:30, players:'11', difficulty:'avansert',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Keeper starter med ball' }, { id:'s2', name:'Steg 2', description:'Spill opp via back → midtbane → front' }, { id:'s3', name:'Steg 3', description:'Fokus: rotasjoner, løpsmønstre' }, { id:'s4', name:'Steg 4', description:'Fra begge sider, 4 ganger hver' }],
  ...
  { id:'fb-k01', sport:'football', category:'keeper', name:'Reaksjonsredning fra kloss hold', duration:15, players:'2', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Keeper i basisstilling' }, { id:'s2', name:'Steg 2', description:'Trener slår baller fra 5–7m raskt' }, { id:'s3', name:'Steg 3', description:'Lav, middels og høye baller' }, { id:'s4', name:'Steg 4', description:'Doble redninger' }, { id:'s5', name:'Steg 5', description:'10 sek pause mellom serier' }],
  ...
  { id:'fb-k02', sport:'football', category:'keeper', name:'1v1 mot keeper', duration:15, players:'2–8', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Angriper 25m fra mål' }, { id:'s2', name:'Steg 2', description:'Dribbler alene mot keeper' }, { id:'s3', name:'Steg 3', description:'Keeper: kom ut til riktig tidspunkt' }, { id:'s4', name:'Steg 4', description:'Bli bred' }, { id:'s5', name:'Steg 5', description:'Redde med beina eller kropp' }],
  ...
  { id:'fb-k03', sport:'football', category:'keeper', name:'Utspark og distribusjon', duration:20, players:'3–6', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Keeper redder' }, { id:'s2', name:'Steg 2', description:'Signal: trener viser side' }, { id:'s3', name:'Steg 3', description:'Kast til riktig spiller' }, { id:'s4', name:'Steg 4', description:'Deretter: utspark med fot' }, { id:'s5', name:'Steg 5', description:'Avansert: keeper bestemmer selv' }],
  ...
  { id:'fb-k04', sport:'football', category:'keeper', name:'Innlegg — komme og klatre', duration:15, players:'3–6', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Innlegger fra flanken' }, { id:'s2', name:'Steg 2', description:'Keeper: "min" eller "ikke min"' }, { id:'s3', name:'Steg 3', description:'Klatre med én arm som skjold' }, { id:'s4', name:'Steg 4', description:'Ta ballen høyest' }, { id:'s5', name:'Steg 5', description:'Rulle ved landing' }],
  ...
  { id:'fb-k05', sport:'football', category:'keeper', name:'Langskudd — posisjonering og diving', duration:15, players:'2–6', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Skyttere fra 18–22m' }, { id:'s2', name:'Steg 2', description:'Posisjon: 1m frem' }, { id:'s3', name:'Steg 3', description:'Mottaksskudd — redde rebound' }, { id:'s4', name:'Steg 4', description:'Diving høyre og venstre' }, { id:'s5', name:'Steg 5', description:'Kurvet ball fra vinkel' }],
  ...
  { id:'fb-f01', sport:'football', category:'fysisk', name:'Sprintintervall 40m', duration:20, players:'alle', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Varm opp 10 min' }, { id:'s2', name:'Steg 2', description:'Sprint 40m × 8 rep' }, { id:'s3', name:'Steg 3', description:'Pause: 60 sek' }, { id:'s4', name:'Steg 4', description:'Serie 2: staggered start' }, { id:'s5', name:'Steg 5', description:'Cool down 5 min' }],
  ...
  { id:'fb-f02', sport:'football', category:'fysisk', name:'Koordinasjonsstige', duration:15, players:'alle', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Én fot inn hvert felt fremover' }, { id:'s2', name:'Steg 2', description:'To fot inn hvert felt' }, { id:'s3', name:'Steg 3', description:'Side-sidepass gjennom stige' }, { id:'s4', name:'Steg 4', description:'Kryss-steg gjennom stige' }, { id:'s5', name:'Steg 5', description:'"In-in-out-out" mønster' }],
  ...
  { id:'fb-f03', sport:'football', category:'fysisk', name:'Plyometri og eksplosive hopp', duration:20, players:'alle', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Squat-jump ×10' }, { id:'s2', name:'Steg 2', description:'Box-jump ×8' }, { id:'s3', name:'Steg 3', description:'Lateral bounds ×10 per side' }, { id:'s4', name:'Steg 4', description:'Hurdle-jump ×8' }, { id:'s5', name:'Steg 5', description:'Tuck-jump ×8' }],
  ...
  { id:'fb-f04', sport:'football', category:'fysisk', name:'HIIT-sirkel 6 stasjoner', duration:25, players:'alle', difficulty:'middels',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'Burpees 45 sek' }, { id:'s2', name:'Steg 2', description:'Push-ups 45 sek' }, { id:'s3', name:'Steg 3', description:'Mountain climbers 45 sek' }, { id:'s4', name:'Steg 4', description:'Squat jumps 45 sek' }, { id:'s5', name:'Steg 5', description:'Plank 45 sek' }, { id:'s6', name:'Steg 6', description:'Lateral shuffle 45 sek; 15 sek pause; 3 runder' }],
  ...
  { id:'fb-f05', sport:'football', category:'fysisk', name:'Endurance-løp aerob basis', duration:30, players:'alle', difficulty:'enkel',
    ...
    steps:[{ id:'s1', name:'Steg 1', description:'30 min jogg 65–70% av makspuls' }, { id:'s2', name:'Steg 2', description:'Du skal KUNNE snakke' }, { id:'s3', name:'Steg 3', description:'Øk 10% per uke over 4 uker' }],
